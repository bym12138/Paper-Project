...
data = [json.loads(line) for line in open(f"/data/home2/kjb/bym/project/BART/getGitData/train.jsonl",'r')]
preds = []
labels = []

def wirte_row(item):
    with open('/data/home2/kjb/bym/project/BART/getGitData/train_rouge.jsonl', 'a') as f: 
            json.dump(item, f)
            f.write("\n")
