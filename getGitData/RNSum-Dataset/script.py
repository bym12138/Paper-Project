...
I_SYNONYMS = open('/data/home2/kjb/bym/project/BART/getGitData/RNSum-Dataset/words/improvements.txt').read().split('\n')
BF_SYNONYMS = open('/data/home2/kjb/bym/project/BART/getGitData/RNSum-Dataset/words/bug_fixes.txt').read().split('\n')
DR_SYNONYMS = open('/data/home2/kjb/bym/project/BART/getGitData/RNSum-Dataset/words/deprecations_removals.txt').read().split('\n')
...
data = []
#'/data/home2/kjb/bym/project/BART/getGitData/RNSum-Dataset/rnsum.jsonl'

df = pd.read_json('/data/home2/kjb/bym/project/BART/getGitData/RNSum-Dataset/rnsum.jsonl', orient='records', lines=True)
...
pd.DataFrame(data).to_json('/data/home2/kjb/bym/project/BART/getGitData/RNSum-Dataset/rnsum_with_text.jsonl', orient='records', lines=True)
