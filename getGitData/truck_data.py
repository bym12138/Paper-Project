...
def process(idx, item):
    ...
    len_commit_messages = len(commit_messages)
    if len_commit_messages <= 10:
        with open('/data/home2/kjb/bym/project/BART/getGitData/train_truck.jsonl', 'a') as f: 
            json.dump(item, f)
            f.write("\n")
...
if __name__ == '__main__':
    ...
    raw_data = [json.loads(line) for line in open('/data/home2/kjb/bym/project/BART/getGitData/train.jsonl','r')]
